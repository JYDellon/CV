...
const ModaleMenuPuzzleGlissant = ({ onClose }) => {
    ...
    const handleOpenMenuPuzzleGlissant = () => {
      setIsModaleMenuPuzzleGlissantOpen(true); // Update state to open ModaleMenuPuzzleGlissant
    };
    ...
    return (
        ...
        <ModalePuzzleGlissant
          ...
          onOpenMenuPuzzleGlissant={handleOpenMenuPuzzleGlissant}
                            ...
                            imageUrl={imageUrl}
                            numberColor={numberColor} // Passer la numberColor comme prop
                        />
                            ...
                            <div className="centrer2">
                                ...
                                <div className="placer">
                                    <label>
                                        ...
                                        <input type="color" id="number-color" value={numberColor} onChange={(e) => setNumberColor(e.target.value)} />choisissez la couleur des chiffres
                                    </label>
                                </div>
